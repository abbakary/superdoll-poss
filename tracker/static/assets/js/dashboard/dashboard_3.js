...
var options = {
  ...
  (function(){
    var el = document.querySelector("#revenuegrowth");
    if(!el) return; 
    var revenuegrowth = new ApexCharts(el, options);
  ...
  (function(){
    var el = document.querySelector("#visitsCharts");
    if(!el) return;
    var visitsCharts = new ApexCharts(el, options);
    visitsCharts.render();
  })();
  
  // echart-polar (direct usage, no AMD)
  (function(){
    if(typeof echarts === 'undefined') return;
    var el = document.getElementById('echart-polar');
    if(!el) return;
